        ...
        <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="news-box">
                            <div class="news-img-holder">
                                <img src="{{asset('assets')}}/images/artikelDanBerita/home/{{ $article->image_path }}" class="img-responsive" alt="research" >
                                <ul class="news-date1">
                                    {{-- <li>{{ date('jS M Y',strtotime($article->updated_at)) }}</li> --}}
                                </ul>
                            </div>
                            <h2 class="title-default-left-bold"><a href="{{url("artikel/$article->id_artikel")}}">{{ $article->judul }}</a></h2>
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="sidebar">
                    ...
                    <div class="sidebar-box">
                        <div class="sidebar-box-inner">
                            <h3 class="sidebar-title">Berita RPL</h3>
                            <div class="sidebar-latest-research-area">
                                <ul>
                                    @foreach ($posts as $post)
                                    <li>
                                        <div class="latest-research-img">
                                            <a href="{{url("artikel/$article->id_artikel")}}"><img src="{{asset('assets')}}/images/artikelDanBerita/{{$post->image_path}}" class="img-responsive" alt="skilled" width="200" height="40"></a>
                                        </div>
